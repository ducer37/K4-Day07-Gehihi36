...
| 5 | Ngoại lệ/troubleshooting | Nếu thanh toán báo lỗi M10 vượt hạn mức thanh toán trong ngày thì Shopee hướng dẫn xử lý thế nào? | `{"category": "payment-troubleshooting"}` | Với lỗi M10, người mua nên đặt hàng lại vào ngày mai. | `shopee-order-payment-errors`, bảng lỗi thanh toán, dòng `Lỗi (M10)`. |
