...
- ChọnMở ứng dụng Shopee(nếu bạn chưa cài đặt ứng dụng Ví ShopeePay trên di động). Tại ứng dụng Shopee, chọn nguồn tiền > chọnThanh toán ngay> NhậpMật khẩu Ví ShopeePayhoặc các phương thức xác thực thanh toán khác đã thiết lập để hoàn tất thanh toán.
